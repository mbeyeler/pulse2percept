"""This module implements the model described in [Nanduri2012]_."""

import numpy as np
from .base import BaseModel
from .scoreboard import ScoreboardModel
from .watson2014 import Watson2014ConversionMixin
from ._nanduri2012 import temporal_update, spatial_update


class Nanduri2012SpatialMixin(Watson2014ConversionMixin):
    ...
    def _predict_pixel_percept(self, xygrid, implant, t=None):
        ...
        bright = spatial_update(implant.stim.data[:, t].ravel(),
...
class Nanduri2012TemporalMixin(object):
    ...
    def _step_temporal_model(self, stim, dt):
        ...
        i, amp = stim
        ca, r1, r2, r4a, r4b, r4c = temp_update(
